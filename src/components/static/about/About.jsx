...
const About = () => {
  return (
    <div className="bg-gradient-to-b from-black w-full flex flex-col items-center pt-30">
          ...
          <div className="relative w-full text-white overflow-hidden bg-about p-3">
            <div className="bg-black/90 backdrop-blur-md p-4">
              ...
              <div className="text-xs md:text-base font-montserrat my-3">
                Rose Hack is UC Riverside&apos;s 24-hour hackathon, one of the
                few women-centric hackathons in California! Founded by the
                female leaders of the Association for Computing Machinery
                (ACM-W) and the Society of Women Engineers (SWE).
              </div>
              ...
              <div className="text-xs md:text-base font-montserrat my-3">
                ...
                underrepresented groups in STEM to gain experience, create
                strong networks, and build amazing projects through their shared
                passions in Science and Technology.
              </div>
            </div>
          </div>
        </Parallax>
