...
const Modal = ({ data, setModal }) => {
  return (
    <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-10 w-1/2 h-3/4 rounded-xl">
      <div className="flex justify-between items-center p-3 rounded-t-xl bg-rosehack-teal">
      ...
      <div className="bg-white px-3 rounded-b-xl py-2 border-x-2 border-b-2 border-hackathon-darkgray h-full flex justify-center">
        <iframe className="h-full" src={data.src} />
      </div>
    </div>
  );
};
